<!-- <script src="https://www.paynimo.com/PaynimoCDN/lib/jquery.min.js" type="text/javascript"></script> -->
  ...
  <div class="content">
        ...
        <?php if(in_array('createCancelMandate', $user_permission) || in_array('updateCancelMandate', $user_permission) || in_array('exportCancelMandate', $user_permission) || in_array('viewCancelMandate', $user_permission)): ?>
        ...
        dataTable.search(searchTerm).draw();
         ...
         function showUsersData(){
            ...
            dataTable =   $('#dataTable').DataTable({
                    ...
                    "ajax": {
                         'type': 'GET',
                         'url': "<?php echo base_url() ?>api/User/showCanceledMandateUsersList/",
                         'async': false,
                         'method':'get',
                         'dataType': 'json',
                         'dataSrc': 'data',
                    ...
                    'columns': [
                         ...
                         { data: 'account_no',name:'mandate_customers.account_no', orderable: false, },
                        {
                            ...
                            <?php if(in_array('exportCancelMandate', $user_permission)): ?>
                              ...
                              if (row.mandate_customer_canceled == 1) {

                                  html += '<a class="btn btn-sm btn-phoenix-success me-1 fs--2 item-canceledtemplatedownload" data="' + row.mandate_customer_id + '" href="javascript:;"><span class="fa-regular fa-circle-down" id="canceledTemplateDownload"></span></a>';
                              ...
                              if (row.mandate_customer_canceled == 1 ) {
                                   ...
                                   html += '<a class="dropdown-item item-canceledtemplatedownload" data="' + row.mandate_customer_id + '" href="javascript:;"><span class="fa-regular fa-circle-down mr-4" style="margin-right: 8px;" id="canceledTemplateDownload"></span>Canceled Template Download</a>';
                              }
...
function exportToExcel() {
   ...
   $(document).ready(function(){
    ...
    $('#userDataMandate').on('click', '.item-canceledtemplatedownload', function(){ 

      var mandate_customer_id = $(this).attr('data');

      var documentUrl = "<?php echo base_url('Users/cancelMandateSheetDownload/'); ?>" +mandate_customer_id;
